...
const LogIn = () => {
    ...
    return (_jsxs("div", { className: styles.loginContainer, children: [_jsxs("div", { className: styles.patternContainer, ref: patternContainerRef, children: [_jsx("img", { src: `${import.meta.env.BASE_URL}login-pattern.png`, alt: "Login pattern", className: styles.patternImage }), _jsx("div", { className: styles.bottomContainer, ref: bottomContainerRef, children: _jsx("div", { className: styles.brandingSvg, children: _jsx("img", { src: `${import.meta.env.BASE_URL}branding.svg`, alt: "Branding Logo", style: { height: '35px', width: 'auto', display: 'block' } }) }) })] }), _jsx("div", { className: styles.loginFormContainer, children: _jsxs("div", { className: styles.loginBox, children: [_jsxs("div", { className: styles.welcomeContainer, children: [_jsx(EnvisageLogo, {}), _jsx("h2", { className: styles.welcomeText, children: "welcome future" }), _jsx("div", { className: styles.welcomeDivider })] }), _jsx("input", { type: "email", placeholder: "email address", className: styles.inputField }), _jsx("input", { type: "password", placeholder: "password", className: styles.inputField }), _jsx("button", { className: styles.loginButton, onClick: handleLogin, children: _jsx(ArrowIcon, { className: styles.rotatedIcon }) })] }) })] }));
};
